...
const int LSM_MAXN = 500;
const int LSM_MAXM = 10000;
const int MAXDIM = 10;
...
double longstaffSchwartzMethodHigherDims(int N, double T, double r, double S_0[MAXDIM], double K, double v[MAXDIM], double q[MAXDIM], int M, int k, double p[MAXDIM][MAXDIM], double w[MAXDIM], callPut callOrPut);
